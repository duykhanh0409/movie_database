...
import { useMovies } from '@/features/home/hooks/useMovies';
import { mapMovieDTO } from '@/services/mappers/movie.mapper';

import { Dropdown } from '@/shared/components/Dropdown';
import { MovieCard } from '@/shared/components/MovieCard';
import { ErrorState } from '@/shared/components/ErrorState';
import { EmptyState } from '@/shared/components/EmptyState';
import { Category, SortOption } from '@/types/api';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      {isLoading && movies.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <MovieCard movie={item} onPress={() => console.log('Go to details', item.id)} />
          )}
